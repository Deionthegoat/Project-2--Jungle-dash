...
Coconut.prototype.type = "coconut";
...
Coconut.prototype.act = function(step, level) {
  var newPos = this.pos.plus(this.speed.times(step));
  if (!level.obstacleAt(newPos, this.size))
    this.pos = newPos;
  else if (this.repeatPos)
...
var wobbspeed = 12, wobbleDis = 0.09;
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  else if (type == "coconut" && this.status == null) {
    this.status = "lost";
    this.finishDelay = 1;
  }
  else if (type == "coin") {
